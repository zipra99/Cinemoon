...
export class TicketInfoService {
  ...
  setBookingSeatInfo(bookingSeatList: Array<string>, listBookingSeatString: string, bookingSeatMoney: number) {
    this.bookingSeatList = bookingSeatList;
    this.listBookingSeatString = listBookingSeatString;
    this.bookingSeatMoney = bookingSeatMoney;
  }
  getBookingSeatString() {
    return this.listBookingSeatString;
  }
  setBookingFoodInfo(bookingFoodList: Array<string>, bookingFoodMoney: number) {
    this.bookingFoodList = bookingFoodList;
    this.bookingFoodMoney = bookingFoodMoney;
  }
  getTotalMoneyString() {
    return (this.bookingSeatMoney + this.bookingFoodMoney).toLocaleString('en').split(',').join('.') + 'đ';
  }
}